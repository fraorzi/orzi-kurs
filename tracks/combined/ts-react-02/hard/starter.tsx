...
export type Action = { type: "add"; amount: number } | { type: "remove"; amount: number } | { type: "reset" };
export function reducer(state: State, _action: Action): State { return state; }
...
export function useCart(): State { return useContext(CartContext) ?? { count: 0 }; }
